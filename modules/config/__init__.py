...
class Config(commands.Cog):
    ...
    async def xp_reward_command_add(
        self, ctx, level: int, role: discord.Role, persistent: bool = False
    ):
    ...
    @birthday_config.command(
        name="channel", description="Set the birthday announcements channel."
    )
    ...
    @command_config.command(
        name="channel", description="Configure where members can use Lumi commands."
    )
    ...
    @command_config.command(
        name="everywhere", description="Allow members to do commands in all channels."
    )
    ...
    @welcome_config.command(
        name="channel", description="Set the greeting announcements channel."
    )
    ...
    @welcome_config.command(
        name="disable", description="Disable greetings in this server."
    )
    ...
    @welcome_config.command(
        name="template", description="Make a custom greeting template."
    )
    async def config_welcome_template(
        self, ctx, *, text: discord.Option(str, max_length=2000)
    ):
        guild_config = GuildConfig(ctx.guild.id)
    ...
    @boost_config.command(
        name="channel", description="Set the boost announcements channel."
    )
    ...
    @boost_config.command(
        name="disable", description="Disable boost announcements in this server."
    )
    ...
    @boost_config.command(
        name="template", description="Make a custom boost announcement template."
    )
    ...
    @level_config.command(
        name="channel", description="Set the level announcements channel."
    )
    ...
    @level_config.command(
        name="disable", description="Disable levels and the Lumi XP system."
    )
    ...
    @level_config.command(
        name="enable", description="Enable levels and the Lumi XP system."
    )
    ...
    @level_config.command(name="type", description="Set the level announcements type.")
    async def config_level_type(
        self, ctx, *, type: discord.Option(choices=["whimsical", "generic"])
    ):
        guild_config = GuildConfig(ctx.guild.id)
    ...
    @level_config.command(
        name="template", description="Make a custom leveling template."
    )
